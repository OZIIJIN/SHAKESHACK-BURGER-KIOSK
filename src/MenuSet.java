...
public class MenuSet {
    static Map<String, Menu> shakeshackMenu = new HashMap<>();
    static String[] menuname;
    static void getShakeshackMenu(){
    ...
    static Map<String, Menu> orderMenu = new HashMap<>();
    static Map<String, Menu> getOrderMenu(){
        orderMenu.put("Cancle", new Menu("Cancle", "진행중인 주문을 취소합니다."));
        orderMenu.put("Order", new Menu("Order", "장바구니를 확인 후 주문합니다."));
        return orderMenu;
    }
    static Map<String, Item> burgerItem = new HashMap<>();
    static String[] menuname_burgers;
    static void getBurgerItem(){
    ...
    static Map<String, Item> custardItem = new HashMap<>();
    static String[] menuname_custard;
    static void getCustardItem(){
    ...
    static Map<String, Item> drinksItem = new HashMap<>();
    static String[] menuname_drinks;
    static void getDrinksItem(){
    ...
    static Map<String, Item> allItem = new HashMap<>();
    static Map<String, Item> putAll(){
